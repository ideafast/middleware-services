...
class Vtt:
    ...
    def authenticate(self):
        ...
        # TODO: update to reflect VTT / S3 setup

    def download_metadata(self) -> None:
        """
        Before downloading raw data we need to know which files to download.
        VTT provides a weekly dump in an S3 bucket

        TODO: understand VTT data structure in the bucket and how to extract \
            metadata from these files
